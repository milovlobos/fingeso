...
public class Property_Controller {
    ...
    public ballot BuyProperty(@PathVariable long PropertyId, @RequestParam long userId, @RequestParam String method_payment) {
        return Property_service.BuyProperty(PropertyId, userId, method_payment);
    }
}